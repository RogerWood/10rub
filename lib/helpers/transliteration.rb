module Nanoc3::Helpers
    ...
    module Transliteration
        ...
        # Возвращает строку, в которой все буквы русского 
        # алфавита заменены на похожую по звучанию латиницу
        ...
        # транслитерирует строку, делая ее пригодной 
        # для применения как имя директории или URL

        def dirify (str)
            st = transliterate (str)
